...
public class AddressBook {
    ...
    private static File file = new File("C:\\\\Users\\\\Sanket\\\\eclipse-workspace\\\\WorkshopAddressbook\\\\src\\\\ContactData.txt");
    ...
    public static void printData() throws IOException {
		try {
			Files.lines(new File("C:\\\\Users\\\\Sanket\\\\eclipse-workspace\\\\WorkshopAddressbook\\\\src\\\\ContactData.txt").toPath())
    ...
    private static void showMainMenu() throws IOException {
        ...
        System.out.println("2. Show all contacts data");
